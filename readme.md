...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - Solana-native trust + x402 receipt layer for AI agents: free preflight trust checks and paid signed V5 trust receipts via Streamable-HTTP MCP at `https://intel.twzrd.xyz/mcp`.
